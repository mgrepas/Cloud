...
--
-- Servidor: localhost
-- Tiempo de generación: 07-12-2012 a las 17:31:10
...
CREATE TABLE IF NOT EXISTS `ciudad` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_892A00A85A91C08D` (`departamento_id`)
...
CREATE TABLE IF NOT EXISTS `estrato` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `estrato` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `estudiante` (
  ...
  `estrato_id` int(11) DEFAULT NULL,
  `sexo_id` int(11) DEFAULT NULL,
  `nivel_id` int(11) DEFAULT NULL,
  `nombre` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `apellidos` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `lugNacimiento` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `fecNacimiento` datetime NOT NULL,
  `numero` int(11) NOT NULL,
  `expedidaEn` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `observacionesPer` longtext COLLATE utf8_unicode_ci NOT NULL,
  `colegioProcedencia` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `sede` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `observacionesAcad` longtext COLLATE utf8_unicode_ci NOT NULL,
  `numPersonas` int(11) NOT NULL,
  `casa` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `telefonoCasa` int(11) NOT NULL,
  `viveCon` tinyint(1) NOT NULL,
  `numHermanos` int(11) NOT NULL,
  `celCasa` int(11) NOT NULL,
  `nomMadre` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `ccMadre` int(11) NOT NULL,
  `nomPadre` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `ccPadre` int(11) NOT NULL,
  `nomAcudiente` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `ccAcudiente` int(11) NOT NULL,
  `direccionCasa` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `user_id_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_74623C7D9D86650F` (`user_id_id`),
  KEY `IDX_74623C7DE8608214` (`ciudad_id`),
  KEY `IDX_74623C7DEF8798C5` (`identificacion_id`),
  KEY `IDX_74623C7D7B3867BD` (`estrato_id`),
  KEY `IDX_74623C7D2B32DB58` (`sexo_id`),
  KEY `IDX_74623C7DDA3426AE` (`nivel_id`)
...
CREATE TABLE IF NOT EXISTS `institucion` (
  ...
  `dane` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `men` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `email` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `rector` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `secretaria` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `distribucion_usuarios` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `modelo_pedagogico` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `foto` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_71CD7814E8608214` (`ciudad_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
INSERT INTO `tipoid` (`id`, `documento`) VALUES
...
INSERT INTO `user` (`id`, `username`, `password`, `salt`, `nombre`, `apellido`, `avatar_url`) VALUES
(1, 'DCFOE', 'I6uHUUQ0BXfBmxGSgiTRUOSulkQJbWfxRi66KjoYfO216CZEzbPw+whCHyPYhL4L1YjYmbKmbmZyJVFAAHIzPQ==', '7f0f1596c09e2f81d80f2292587dad98', 'Cloud', 'School', 'cloudschool.png');
...
ALTER TABLE `estudiante`
  ADD CONSTRAINT `FK_74623C7D2B32DB58` FOREIGN KEY (`sexo_id`) REFERENCES `sexo` (`id`),
  ADD CONSTRAINT `FK_74623C7D7B3867BD` FOREIGN KEY (`estrato_id`) REFERENCES `estrato` (`id`),
  ADD CONSTRAINT `FK_74623C7D9D86650F` FOREIGN KEY (`user_id_id`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `FK_74623C7DDA3426AE` FOREIGN KEY (`nivel_id`) REFERENCES `nivel` (`id`),
  ADD CONSTRAINT `FK_74623C7DE8608214` FOREIGN KEY (`ciudad_id`) REFERENCES `ciudad` (`id`),
  ADD CONSTRAINT `FK_74623C7DEF8798C5` FOREIGN KEY (`identificacion_id`) REFERENCES `tipoid` (`id`);

--
-- Filtros para la tabla `institucion`
--
ALTER TABLE `institucion`
  ADD CONSTRAINT `FK_71CD7814E8608214` FOREIGN KEY (`ciudad_id`) REFERENCES `ciudad` (`id`);
