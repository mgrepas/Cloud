...
namespace Frontend\EstudianteBundle\Entity;

use Doctrine\ORM\Mapping as ORM;

/**
 * Frontend\EstudianteBundle\Entity\Estudiante
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Frontend\EstudianteBundle\Entity\EstudianteRepository")
 */
class Estudiante
{
    /**
     ...
     *
     * @ORM\ManyToOne(targetEntity="Frontend\AjustesGeneralesBundle\Entity\TipoId")
     */
     ...
     * @var string $estrato
     *
     * @ORM\ManyToOne(targetEntity="Frontend\AjustesGeneralesBundle\Entity\Estrato")
     */
    private $estrato;
     ...
     * @var string $sexo
     *
     * @ORM\ManyToOne(targetEntity="Frontend\AjustesGeneralesBundle\Entity\Sexo")
     */
    private $sexo;
     ...
     * @var string $sede
     *
     * @ORM\ManyToOne(targetEntity="Frontend\AjustesGeneralesBundle\Entity\Sede")
     */
    private $sede;
     ...
     *
     * @ORM\Column(name="observacionesAcad", type="string", length=255)
     */
     ...
     * Set identificacion
     *
     * @param Frontend\AjustesGeneralesBundle\Entity\TipoId $identificacion
     * @return Estudiante
     */
    public function setIdentificacion(\Frontend\AjustesGeneralesBundle\Entity\TipoId $identificacion = null)
    {
     ...
     * Get identificacion
     *
     * @return Frontend\AjustesGeneralesBundle\Entity\TipoId 
     */
     ...
     * Set sexo
     *
     * @param Frontend\AjustesGeneralesBundle\Entity\Sexo $sexo
     * @return Estudiante
     */
    public function setSexo(\Frontend\AjustesGeneralesBundle\Entity\Sexo $sexo = null)
    {
        $this->sexo = $sexo;
     ...
     * Get sexo
     *
     * @return Frontend\AjustesGeneralesBundle\Entity\Sexo 
     */
     ...
     * Set sede
     *
     * @param Frontend\AjustesGeneralesBundle\Entity\Sede $sede
     * @return Estudiante
     */
    public function setSede(\Frontend\AjustesGeneralesBundle\Entity\Sede $sede = null)
    {
        $this->sede = $sede;
     ...
     * Get sede
     *
     * @return Frontend\AjustesGeneralesBundle\Entity\Sede 
     */
     ...
     * Set estrato
     *
     * @param Frontend\AjustesGeneralesBundle\Entity\Estrato $estrato
     * @return Estudiante
     */
    public function setEstrato(\Frontend\AjustesGeneralesBundle\Entity\Estrato $estrato = null)
    {
     ...
     * Get estrato
     *
     * @return Frontend\AjustesGeneralesBundle\Entity\Estrato 
     */
